...
public class Battleship {
    ...
    static String playerName1 = "playerName1";
    static String playerName2 = "playerName2";
    ...
    public static void placeShips(String playerName, int[][] battlefield) {//1 четырехпалубный; 1 трехпалубный; 1 двухпалубный; 1 однопалубный
        int deck = 4;
        while (deck >= 1) {
            System.out.println();
    ...
    public static void makeTurn(String playerName, int[][] monitor, int[][] battlefield) {//0 - не стреляли; 1 - не попали; 2 - попали
    ...
    public static boolean isAvailable(int x, int y, int deck, int rotation, int[][] battlefield) {
        ...
        while (deck != 0) {
            ...
            for (int i = 0; i < deck; i++) {
                ...
                if (x - 1 < battlefield.length && x - 1 >= 0) {
                    if (battlefield[x - 1 + xi][y + yi] != 0) {
                        return false;
                    }
                }
